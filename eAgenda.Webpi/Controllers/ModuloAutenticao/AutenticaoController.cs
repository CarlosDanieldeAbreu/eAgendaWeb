...
namespace eAgenda.Webpi.Controllers.ModuloAutenticao
{
    [Route("api/conta")]
    [ApiController]
    public class AutenticaoController : eAgendaControllerBase
    {
        private readonly ServicoAutenticacao servicoAutenticacao;
        private readonly IMapper mapeadorUsuario;

        public AutenticaoController(ServicoAutenticacao servicoAutenticacao, IMapper mapeadorUsuario)
        {
